...
class GameServer
{
    ...
    private void playerShoot(SPlayer pPlayer)
    {
        ...
        try
        {
            ...
            {
                System.err.println("1getline failed for player " + pPlayer.mID);
        ...
        {
            System.err.println("2getline failed for player " + pPlayer.mID);
            pPlayer.mGameOver = true;
            return;
        }
    ...
    private void playerGuess(SPlayer pPlayer)
    {
        ...
        try
        {
            if ((lString = pPlayer.mInputStream.readLine()) == null)
            {
                System.err.println("3getline failed for player " + pPlayer.mID);
                pPlayer.mGameOver = true;
                return;
            }
        }
        ...
        {
            System.err.println("4getline failed for player " + pPlayer.mID);
            pPlayer.mGameOver = true;
            return;
        }
